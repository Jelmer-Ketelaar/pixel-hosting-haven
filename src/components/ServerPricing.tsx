  ...
  return (
    <section id="pricing" className="section-container">
          ...
          <div className="glass-effect p-1 rounded-full inline-flex">
            ...
            >
              ...
              {billingPeriod === 'yearly' ? null : (
                <span className="absolute -top-3 -right-2 bg-minecraft-green text-white text-xs px-2 py-0.5 rounded-full animate-pulse-light">
                  Save 20%
                </span>
              )}
            </button>
      ...
      <div className="mt-16 text-center animate-on-scroll opacity-0">
        ...
        <Button onClick={() => navigate('/contact')} className="px-6">Contact Sales</Button>
      </div>
    </section>
  );
};
